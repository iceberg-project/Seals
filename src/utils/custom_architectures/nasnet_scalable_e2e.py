...
class Regress(nn.Module):
    ...
    def __init__(self, depth=5, num_classes=11):
        super(Regress, self).__init__()
        self.feed_forward = nn.Sequential()
        for idx in range(depth):
            self.feed_forward.add_module('linear{}'.format(idx), module=nn.Linear(num_classes, num_classes))
            self.feed_forward.add_module('relu{}'.format(idx), module=nn.ReLU())
        self.feed_forward.add_module('final', module=nn.Linear(num_classes, 1))
...
class NASNetAe2e(nn.Module):
    ...
    def __init__(self, in_channels_0, out_channels_0, out_channels_1, out_channels_2, out_channels_3, num_classes=11):
        ...
        self.regress = Regress(num_classes=num_classes, depth=0)

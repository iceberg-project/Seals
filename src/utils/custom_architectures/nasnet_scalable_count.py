# adapted from https://github.com/Cadene/pretrained-models.pytorch/blob/master/pretrainedmodels/models/nasnet_mobile.py
...
class NASNetAMobile(nn.Module):
    ...
    def __init__(self, num_classes=1001, stem_filters=32, penultimate_filters=1056, filters_multiplier=2):
        ...
        self.relu = nn.ReLU()
        self.avg_pool = nn.AvgPool2d(13, stride=2, padding=0)
        self.dropout = nn.Dropout()
        self.last_linear = nn.Linear(12*filters, self.num_classes)
...
def NASNetA_count(num_classes=1):
